<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deklarka.aspx.cs" Inherits="z7_1.deklarka" EnableViewState="true" %>
       ...
       <div>
            <table>
                ...
                <tr>
                    ...
                    <td><asp:TextBox runat="server" type="date" ID="dateTB"/></td>
                </tr>
                <tr>
                ...
                <asp:Repeater runat="server" ID="TasksRepeater" EnableViewState="True" ViewStateMode="Enabled">
                    ...
                    <tr>
                        ...
                        <td><asp:TextBox type="number" runat="server" ID="TaskNTB"/></td>
                    </tr>
                    </ItemTemplate>
                </asp:Repeater>
