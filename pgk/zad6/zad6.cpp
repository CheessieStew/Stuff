...
#pragma endregion
	...
	GLuint PlayerTexture(loadDDS("Assets/anglerfish.DDS"));
	...
	Model3d SkyBoxModel(Model3d("Assets/skybox.obj"));

	GLuint BestShaderEver(LoadShaders("Assets/BestVertexShaderEver.vert", "Assets/BestFragmentShaderEver.frag"));
	GLuint BestShaderEverNoise(LoadShaders("Assets/BestVertexShaderEver.vert", "Assets/BestFragmentShaderEverNoise.frag"));
